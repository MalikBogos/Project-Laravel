...
class PostSeeder extends Seeder
{
    public function run()
    {
        ...
        Post::create([
            ...
            'cover_image' => 'colomapark.png', // Correct path
            'published_at' => now(),
        ]);
        ...
        Post::create([
            ...
            'cover_image' => 'history.png', // Correct path
            'published_at' => now(),
        ]);
        ...
        Post::create([
            ...
            'cover_image' => 'events.png', // Correct path
            'published_at' => now(),
        ]);
        ...
        Post::create([
            ...
            'cover_image' => 'restaurants.png', // Correct path
            'published_at' => now(),
        ]);
